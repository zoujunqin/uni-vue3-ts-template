...
export const typeMap = {
  [NETWORK_ERROR]: {
    ...
    image: import('@@static/placeholder/network-error.png')
  },
  [NO_MSG]: {
    title: '暂时无消息！',
    subTitle: '没有新的消息，在等等...',
    image: import('@@static/placeholder/no-msg.png')
  },
  [NO_PAGE_INFO]: {
    title: '哎呦！页面信息飞走了',
    subTitle: '不好意思，页面君飞走了~',
    image: import('@@static/placeholder/no-page-info.png')
  },
  [EMPTY_DATA]: {
    title: '没有搜索到',
    subTitle: '被您难倒了，换个词试试看~',
    image: import('@@static/placeholder/empty-data.png')
  },
  [NO_ADDRESS]: {
    title: '暂无地址信息',
    subTitle: '暂无地址信息，去添加地址~',
    image: import('@@static/placeholder/no-address.png')
  }
} as const;
