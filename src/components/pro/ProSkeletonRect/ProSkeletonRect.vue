...
import { provideKey } from '../ProSkeleton/const';
import { rectProps } from '../ProSkeletonRect/props';
...
const skeletonRectStyle = computed(() => {
  const {
    width,
    height,
    bgColor,
...
<script lang="ts">
export default {
  options: { name: 'ProSkeletonRect', virtualHost: true }
};
</script>
